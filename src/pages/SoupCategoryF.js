...
import Content from "../sections/soupCategoryF/Content";
import {
  getAllRestaurants,
...
function SoupCategoryF() {
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>Salad Factory | Other Soups Categories</title>
      ...
      />
       <Content selectedRestaurantId={selectedRestaurantId} />
      <Footer />
    </Fragment>
  );
}

export default SoupCategoryF;
