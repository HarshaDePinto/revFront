...
function Content() {
  ...
  const [showAllAddons, setShowAllAddons] = useState(true);
  ...
  const showAdding = () => (
    ...
    >
      <h4>Submit Addon to adding {restaurantName} ....</h4>
    </div>
  );
  ...
  const showRemoving = () => (
    ...
    >
      <h4>Addon remove from {restaurantName} ....</h4>
    </div>
  );
                          ...
                          <div className="general-sec">
                            <div className="row">
                              <div className="col-12">
                               ...
                               {showAdding()}
                               {showRemoving()}
                               {showAllAddons && !adding && !removing && (<ShowAll setShowAllAddons={setShowAllAddons} setAdding={setAdding} setRemoving={setRemoving} restaurantId={restaurantId} />)}
