...
function Content() {
  ...
  const [showAllSalads, setShowAllSalads] = useState(true);
  ...
  const showAdding = () => (
    ...
    >
      <h4>Submit Salad to adding {restaurantName} ....</h4>
    </div>
  );
  ...
  const showRemoving = () => (
    ...
    >
      <h4>Salad remove from {restaurantName} ....</h4>
    </div>
  );
                          ...
                          <div className="general-sec">
                            <div className="row">
                              <div className="col-12">
                               ...
                               {showAdding()}
                               {showRemoving()}
                               {showAllSalads && !adding && !removing && (<ShowAll setShowAllSalads={setShowAllSalads} setAdding={setAdding} setRemoving={setRemoving} restaurantId={restaurantId} />)}
