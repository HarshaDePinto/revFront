                  ...
                  <div className="row">
                    <div className="col-xl-4 col-lg-5 mb-md-40">
                      <ul className="step-steps steps-2">
                        ...
                        <li className="add-res-tab">
                          <Link to="/designer/allFoodItems" className="add-res-tab">
                          All Food Items
                          </Link>
                        </li>
                        ...
                        <li className="add-res-tab">
                          <Link to="/designer/inventory" className="add-res-tab">
                          Inventory
                          </Link>
                        </li>
                        <li className="add-res-tab">
                          <Link to="/designer/mainSlides" className="add-res-tab">
                          Main Slides
                          </Link>
                        </li>
                      </ul>
                        ...
                        <div className="step-tab-panel active" id="steppanel1">
                          <div className="general-sec">
                            ...
                            <div className="row">
                              <div className="col-6">
                                <Link
                                  to="/designer/saladCategory"
                                  className="add-res-tab"
                                >
                                  <StyledButton>Salad Categories</StyledButton>
                                </Link>
                              </div>
                              <div className="col-6">
                                <Link
                                  to="/designer/foodCategory"
                                  className="add-res-tab"
                                >
                                  <StyledButton>Food Categories</StyledButton>
                                </Link>
                              </div>
                              <div className="col-6">
                                <Link
