...
function Content() {
  ...
  const showAdding = () => (
    ...
    >
      <h4>Submit food to adding {restaurantName} ....</h4>
    </div>
  );
  ...
  const showRemoving = () => (
    ...
    >
      <h4>food remove from {restaurantName} ....</h4>
    </div>
  );
                          ...
                          <div className="general-sec">
                            <div className="row">
                              <div className="col-12">
                               ...
                               {showAdding()}
                               {showRemoving()}
                               {showAllFoods && !adding && !removing && (<ShowAll setShowAllFoods={setShowAllFoods} setAdding={setAdding} setRemoving={setRemoving} restaurantId={restaurantId} />)}
