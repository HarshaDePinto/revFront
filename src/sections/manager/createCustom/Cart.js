...
import { setCartAll, clearCart } from "./apiCreateCustom";
          ...
          <div className="card-body no-padding ">
            ...
            <div className="row ml-2">
              <div className="col-12">
                {selectedCustomLettuce && selectedCustomLettuce.length > 0 && (
            ...
            <div className="row ml-2">
              <div className="col-12">
                {selectedCustomThrow && selectedCustomThrow.length > 0 && (
            ...
            <div className="row ml-2">
              <div className="col-12">
                {selectedCustomProtein && selectedCustomProtein.length > 0 && (
            ...
            <div className="row ml-2">
              <div className="col-12">
                {selectedCustomDressing && selectedCustomDressing.length > 0 && (
            ...
            <div className="row ml-2">
              <div className="col-8">
                {selectedCustomDressing &&
                  selectedCustomDressing.map((a, i) => (
                    <div key={i} className="row">
            ...
            <div className="row ml-2">
              <div className="col-12">
                {selectedPremiumAddon && selectedPremiumAddon.length > 0 && (
            ...
            <div className="row ml-2">
              <div className="col-12">
                {selectedGeneralAddon && selectedGeneralAddon.length > 0 && (
            ...
            <div className="row ml-2">
              ...
              <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="col-5">
                      <b>{totalCustomProteinPrice} LKR</b>
                      <hr />
                    </div>
                  </div>
                )}
                ...
                {totalPremiumAddonPrice > 0 && (
                  <div className="row">
                    ...
                    <div className="col-5">
                      <b>{totalPremiumAddonPrice} LKR</b>
                      <hr />
                    </div>
                  </div>
                )}
                ...
                {totalGeneralAddonPrice > 0 && (
                  <div className="row">
                    ...
                    <div className="col-5">
                      <b>{totalGeneralAddonPrice} LKR</b>
                      <hr />
                    </div>
                  </div>
                )}
