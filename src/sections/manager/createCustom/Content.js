...
import { getAllCustoms } from "./apiCreateCustom";
...
function Content() {
  ...
  const [showAllCustom, setShowAllCustom] = useState(true);
  ...
  const setSingleCustom = (c) => {
    setCustom(c);
    setShowAllCustom(false);
    setShowSingleCustom(true);
  };
