          ...
          <Collapse in={open}>
            <div>
              <div className="card-body no-padding">
                <div className="row">
                {showLoading()}
                  {allSoups && allSoups.map((item, i) => (
                    <div key={i} className="col-lg-12">
                      <SingleSoup soup={item} selectedRestaurantId={selectedRestaurantId}/>
                    </div>
                  ))}
                </div>
              </div>
