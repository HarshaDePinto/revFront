...
function OngoingOrder({ ongoingOD }) {
  const resetCart = (o) => {
      ...
      <div className="col-lg-5">
        <div className="price-table u-line">
          ...
          {o.discountPromotion > 0 && (
            <div className="item">
              {" "}
              <span className="text-light-white">Promotion {o.promotionCode}:</span>
              <span className="text-light-white">-{o.discountPromotion.toFixed(2)} LKR</span>
            </div>
          )}
        </div>
  ...
  const showPaymentMethod = (paymentMethod) => {
    ...
    if (paymentMethod === 2) {
      return (
        <div className="method-type">
          {" "}
          <i class="fas fa-money-check-alt text-dark-white"></i>
      ...
      <div className="tracking-sec">
        <div className="tracking-details padding-20 p-relative">
          <h2 className="text-light-black fw-700 no-margin">
            Order Accepted and start to prepare...
          </h2>
            ...
            <ul className="step-steps">
              ...
              <li className="done">
                <Link to="#">
                  {" "}
                  <span className="number" />
                  <span className="step-name">Accept By Restaurant</span>
                </Link>
              </li>
              <li>
                <Link to="#">
                              ...
                              {p.discount > 0 && (
                                <div className="row">
                                  ...
                                  <div className="col-5">
                                    <b>
                                      -{" "}
                                      {(p.itemPrice - p.itemPrice).toFixed(
                                        2
                                      )}{" "}
                                      LKR
                                    </b>
            ...
            <div className="row">
              <div className="col-lg-7">
                <div className="payment-method mb-md-40">
                  ...
                  {showPaymentMethod(o.paymentMethod)}
                </div>
              </div>
              {resetCart(o)}
            </div>
